...
import { useActivityTypes } from 'src/hooks/use-masters';

import { deleteActivityType } from 'src/api/masters';
...
export function ActivityTypeView() {
  ...
  const { data, total, loading, refetch } = useActivityTypes(
    page + 1,
    rowsPerPage,
    filterName,
    orderBy,
    ...
    <DashboardContent maxWidth={false} sx={{mt: 2}}>
      ...
      <ActivityTypeDialog
        ...
        onSuccess={() => {
          setSnackbar({
            open: true,
            message: `Activity Type ${selectedId ? 'updated' : 'created'} successfully`,
            severity: 'success',
          });
          refetch();
        }}
      ...
      <ConfirmDialog
        ...
        title="Delete"
        content="Are you sure you want to delete this activity type?"
        action={
