...
import { generateMeetingPdf } from 'src/components/export/pdf/meeting-pdf-generator';
...
export function MeetingReportView() {
    ...
    const hasCustomPerms = user?.permissions?.custom_permissions_assigned && user?.permissions?.actions?.meeting_report;
    const canExport = hasCustomPerms && user?.permissions?.actions?.meeting_report ? !!user?.permissions?.actions?.meeting_report?.export : true;
            ...
            <Stack spacing={3}>
                ...
                {currentView === 'list' ? (
                    ...
                    <MeetingCalendar
                        ...
                        fromDate={fromDate}
                        toDate={toDate}
                        onEventClick={handleViewMeeting}
                    />
                )}
            </Stack>
