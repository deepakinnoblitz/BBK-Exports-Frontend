...
export function InvoiceCreateView() {
    ...
    const [items, setItems] = useState<ItemRow[]>(estimationData?.table_qecz || [
        {
            service: '',
            hsn_code: '',
            description: '',
    ...
    const [discountType, setDiscountType] = useState<'Flat' | 'Percentage'>(estimationData?.overall_discount_type || 'Flat');
