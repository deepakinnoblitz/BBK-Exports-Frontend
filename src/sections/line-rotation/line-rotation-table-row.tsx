...
export function LineRotationTableRow({
  row,
  index,
  onViewRow,
  onEditRow,
  ...
  const { user } = useAuth();
  const hasCustomPerms = user?.permissions?.custom_permissions_assigned && user?.permissions?.actions?.line_rotation;
  const displayEdit = hasCustomPerms ? !!user?.permissions?.actions?.line_rotation?.edit : canEdit;
  const displayDelete = hasCustomPerms ? !!user?.permissions?.actions?.line_rotation?.delete : canDelete;
