...
export function WhatsAppCampaignsCreateView() {
    ...
    const handleCreate = async () => {
        ...
        try {
            ...
            setSnackbar({ open: true, message: 'WhatsApp Campaign created successfully', severity: 'success' });

            sessionStorage.setItem(
                'whatsapp_campaign_success',
            ...
            setSnackbar({ open: true, message: friendlyMsg || 'Failed to create WhatsApp Campaign', severity: 'error' });
        } finally {
            setCreating(false);
        }
    };
    ...
    return (
        <DashboardContent maxWidth={false} sx={{ mt: 2 }}>
            ...
            <Card sx={{ p: 3, mb: 3 }}>
                <Typography sx={{ mb: 3, ml: 1, fontWeight: 700, fontSize: 16 }}>
                    Scheduling
                </Typography>
